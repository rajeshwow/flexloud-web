...
export default function AppShell({ children, user, onLogout }: Props) {
    ...
    return (
        ...
        .fl-sider .ant-menu-item-selected{
          background: transparent !important; /* pill handles bg */
          color: #fff !important;
          font-weight: 700;
        }
                ...
                <div className="fl-menuWrap" ref={menuWrapRef}>
                    ...
                    <Menu
                        ...
                        items={(collapsed
                            ? navItems.map((i) => ({
                                ...i,
                                icon: <Tooltip placement="right" title={i.label}>{i.icon}</Tooltip>,
                                label: null,
                            }))
                            : navItems) as any}
                ...
                <div style={{ position: "absolute", bottom: 0, left: 0, right: 0 }}>
                    <div className="fl-profile" style={{ justifyContent: collapsed ? "center" : "space-between" }}>
                        <Space>
                            ...
                            {!collapsed && (
                                <div style={{ lineHeight: 1.1 }}>
                                    <div style={{ color: "var(--fl-text)", fontWeight: 800 }}>
                                        {user?.name || "Admin"}
                                    </div>
                                    <div style={{ color: "var(--fl-text2)", fontSize: 12, maxWidth: 150, overflow: "hidden", textOverflow: "ellipsis" }}>
